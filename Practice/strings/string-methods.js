...
const iterator = string5.matchAll("hello");

document.getElementById("print").innerHTML = Array.from(iterator);
*/
...
const text = "Smit Patel";
console.log("includes :" , text.includes("it"));

console.log("includes :" , text.includes("op"));

// startsWith

const studentName = "Smit Patel";
console.log("StartsWith :", studentName.startsWith("smit") );
console.log("StartsWith :", studentName.startsWith("Smit") );
console.log("StartsWith :", studentName.startsWith("p") );


// endsWith

const lastName = "Patel patel";

console.log("EndsWith :" , lastName.endsWith("patel")) ;
console.log("EndsWith :" , lastName.endsWith("l")) ;
console.log("EndsWith :" , lastName.endsWith("L")) ;
